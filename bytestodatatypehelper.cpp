...
uint32_t bytesToUInt32(char byte3, char byte2, char byte1, char byte0)
{
    ...
    uint32Value = (((unsigned char) byte0)&255);
    uint32Value = (((unsigned char) byte1)&255) << 8 | uint32Value;
    uint32Value = (((unsigned char) byte2)&255) << 16 | uint32Value;
    uint32Value = (((unsigned char) byte3)&255) << 24 | uint32Value;
